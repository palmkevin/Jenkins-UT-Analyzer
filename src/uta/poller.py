        ...
        try:
            _with_retries(
                lambda build=build: ingest_build(
                    ...
                    feed=feed,
                    data_change_max_lookback=data_change_max_lookback,
                    ...
                    ingest_build_incidents=ingest_build_incidents,
                ),
    ...
    *,
    ...
    try:
        processed = poll_once(
            client,
            session_factory,
            expected_tracks=cfg.expected_tracks,
            feed=feed,
            data_change_max_lookback=timedelta(days=cfg.data_change_max_lookback_days),
            ...
            svn_blame_client=svn_blame_client,
            ingest_build_incidents=cfg.ingest_build_incidents,
